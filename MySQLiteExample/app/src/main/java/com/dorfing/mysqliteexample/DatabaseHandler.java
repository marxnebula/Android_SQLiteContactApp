 ...
 * It stores ID, name, and phone number.
 * Functions include adding a contact, getting a single contact, getting
 * all contacts, getting the number of contacts, updating a contact,
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void addContact(Contact contact) {
        ...
        // Once we insert data in database we need to close
    ...
    public Contact getContact(int id) {
        ...
        // Create a contact with the information
    ...
    // Function will return total number of contacts in SQLite database.
    ...
    public int updateContact(Contact contact) {
        ...
        // Update the info using correct id
